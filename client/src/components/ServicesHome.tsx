        ...
        <section className="services-container">
            ...
            <div className="card-container">
                <ServiceCard 
                    ...
                    imageURL="/public/assets/lift-tint-icon.png"
                />
                <ServiceCard 
                    ...
                    imageURL="/public/assets/classic-icon.PNG"
                />
                <ServiceCard 
                    ...
                    imageURL="/public/assets/angel-wet-icon.png"
                />
                <ServiceCard 
                    title="Hybrid Lashes"
                    ...
                    imageURL="/public/assets/hybrid-icon.png"
                />
                <ServiceCard 
                    title="Volume Lashes"
                    ...
                    imageURL="/public/assets/volume-icon.png"
                />
                <ServiceCard 
                    title="Wispy Volume"
                    ...
                    imageURL="/public/assets/wispy-volume-icon.png"
                />
            </div>
